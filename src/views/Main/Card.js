      ...
      preConfirm: async () => {
        ...
        try {
          const driverProfile = {
            ...
            p_CnfDate: moment(new Date()).format('YYYYMMDD HH:mm'),
        ...
        <div className="row">
          <div className="col-8">
            <div className="detail">
              <span className="font-weight-bold">ผู้รับ :</span>&nbsp;
              {data.CustName}
            </div>
            <div className="detail">
            ...
            <div className="detail">
              <span className="font-weight-bold">รหัสของผู้รับ :</span>&nbsp;
              {data.CustCode}
            </div>
          </div>
          ...
          {isComplete ? (
            ...
            <div className="col-2 p-0 d-flex align-items-center pointer justify-content-center">
              <img
                ...
                alt="location-icon"
                onClick={() =>
                  window.open(`http://maps.google.com?q=${data.Address}`)
                }
              />
            </div>
          )}
